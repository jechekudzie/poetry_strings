                        ...
                        <div class="col-md-6">
                            <div class="card mb-4 shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{url('/choose_copy/'.$book->getSoftCopy()->id)}}" class="btn btn-block btn-outline-primary">Choose Copy</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="card mb-4 shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{url('/choose_copy/'.$book->getHardCopy()->id)}}" class="btn btn-block btn-primary">Choose Copy</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row align-items-center justify-content-center">
                    ...
                    <!-- end pricing item -->
                    <!-- start pricing item -->
                    <div class="col-12 col-lg-4 col-md-8 text-center pricing-box-style1 md-margin-30px-bottom wow animate__fadeInUp"
                        data-wow-delay="0.2s"

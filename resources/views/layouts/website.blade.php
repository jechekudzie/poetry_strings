...
<nav class="navbar navbar-expand-lg <!--navbar-light--> {{ request()->path() != '/' ? 'bg-light' : '' }} fixed-top">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a style="color: white;" class="nav-link" href="#about">About Ruth</a>
                </li>
                <li class="nav-item">
                    <a style="color: white;" class="nav-link" href="#poems">Poems</a>
                </li>
                <li class="nav-item">
                    <a style="color: white;" class="nav-link" href="#wheretobuy">Where to Buy</a>
                </li>
            </ul>
        </div>
    </div>
